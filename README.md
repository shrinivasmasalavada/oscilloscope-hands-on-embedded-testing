# oscilloscope-hands-on-embedded-testing
Hands-on experience with oscilloscopes for embedded hardware testing and signal analysis during my research internship at IIT Dharwad. This repository documents my practical learning, measurement techniques, waveform analysis, and PCB-level debugging using oscilloscope test equipment.
...
# Oscilloscope-Based Embedded Hardware Testing

## 📌 Overview

This repository documents my hands-on experience using an **oscilloscope for embedded hardware testing, electrical signal measurement, waveform analysis, and PCB-level debugging** during my research internship at **IIT Dharwad**.

The work involved observing and analyzing electrical signals on embedded hardware, validating expected signal behavior, and using measurement equipment to support hardware debugging and testing.

## 🏢 Experience

**Research Internship — IIT Dharwad**

**Focus:** Embedded Systems, Hardware Testing & Signal Analysis
...
* Connected oscilloscope probes to appropriate PCB test points.
* Verified electrical signals against expected behavior.
* Observed voltage variations with respect to time.

### 2. Waveform Analysis

* Studied different signal waveforms.
* Measured amplitude, frequency, period and duty cycle.
* Observed signal stability and noise.

### 3. Embedded Hardware Debugging

* Used oscilloscope measurements to investigate hardware behavior.
* Checked signals at different points of an embedded system.
* Compared expected and observed waveforms during debugging.

### 4. Communication Signal Analysis

* Observed digital communication signals generated by embedded systems.
* Used waveform characteristics to understand signal timing and behavior.

### 5. Hardware Validation

* Performed repeated measurements during hardware testing.
* Recorded observations and measurement results.
* Used test results to support troubleshooting and validation.

## 📊 Key Measurements

| Parameter           | Purpose                             |
| ------------------- | ----------------------------------- |
| Voltage / Amplitude | Verify signal level                 |
| Frequency           | Verify signal frequency             |
| Period              | Analyze signal timing               |
| Duty Cycle          | Analyze PWM/digital signals         |
| Rise/Fall Time      | Evaluate signal transitions         |
| Noise               | Identify unwanted signal variations |

## 📁 Repository Structure

```text
oscilloscope-embedded-testing/
│
├── README.md
├── images/
│   ├── oscilloscope-setup.jpg
│   ├── pcb-testing.jpg
...
│
├── documentation/
│   ├── oscilloscope-basics.md
│   ├── probing-techniques.md
│   └── waveform-analysis.md
│
└── notes/
    └── learning-notes.md
```
...
This repository contains personal learning notes and non-confidential technical observations from my hands-on experience. No proprietary, restricted, or confidential information from IIT Dharwad or any associated project is included.

## 🚀 Future Learning

* UART waveform analysis
* SPI signal analysis
* I²C signal analysis
* PWM analysis
* CAN signal analysis
...
* Python-based measurement analysis

---

**Author:** Shrinivas A. M.
**Area:** Embedded Systems | Hardware Testing | Signal Analysis
**Experience:** IIT Dharwad Research Internship
